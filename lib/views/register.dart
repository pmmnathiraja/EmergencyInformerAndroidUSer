...
import 'package:user/loginInit.dart';
...
class _RegisterPageState extends State<RegisterPage> {
      ...
      child: Form(
        ...
        child: Column(
          children: <Widget>[
            ...
            formFieldSpacing,
            buildFormNICNumberField(
                'NIC Number', LineIcons.lock, _nationalIDNumberController),
            formFieldSpacing,
          ],
        ),
      ),
      ...
      validator: (String value) {
        if (value.isNotEmpty) {
          if (!isNumeric(_textController.text) &&
              !isLength(_textController.text, 9, 10)) {
  ...
  Widget buildFormNICNumberField(
      String label, IconData icon, TextEditingController _textController) {
    return TextFormField(
      controller: _textController,
      decoration: InputDecoration(
  ...
  void userUploadData() async {
    FirebaseFirestore.instance.collection("Users").doc(_nationalIDNumberController.text).set({
...
//    Firestore.instance
//        .collection("Users")
//        .document(_nationalIDNumberController.text)
//        .setData({
//      'Name': _nameController.text,
//      'Email Address': _emailController.text,
//      'Phone Number': _phoneNumberController.text,
